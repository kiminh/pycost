...
To create your package, you need to clone the ``pycost`` repository::

    $ git clone https://github.com/scikit-learn-contrib/pycost.git

Before to reinitialize your git repository, you need to make the following
changes. Replace all occurrences of ``pycost`` and ``pycost``
